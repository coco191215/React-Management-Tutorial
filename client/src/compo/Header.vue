<template>
 <header class='header-register' >
    ...
    <div @click="goHome" class="uou-logo">
      <img style="pointer-events: none" src="uou-logo.png" />
    </div>
    <div class="timmer">
      <div class="time">
...
.timmer .home-img {
  ...
  height: 27px;
  object-fit: contain;
  filter: opacity(0.5) drop-shadow(0 0 0 rgb(236, 236, 236));
}
.timmer .home::after {
  content: "";
  width: 1px;
